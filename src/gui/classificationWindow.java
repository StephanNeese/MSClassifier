	...
	public void runProgram(){
		...
		help.addActionListener(
				new ActionListener(){
					...
					public void actionPerformed(ActionEvent e){
						JFrame frame = new JFrame();
						String msg = "Using a created profile you can classify new samples of food.\n"
								...
								+ "Elements:\n"
								+ "folder with CSV files: The folder in which all the csv files lie in.\n"
								+ "    The files must all lay in the same folder. Subfolders are not recognized.\n"
								+ "    You can search for the folder using the search button to the right of the field.\n"
								...
								+ "All spectra will be classified and the results will pop up on screen\n"
								+ "in a table and will be additionally saved to your log file.";
						JOptionPane.showMessageDialog(frame, 
									msg, 
									"Help", 
